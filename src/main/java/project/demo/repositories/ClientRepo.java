...
public class ClientRepo {
    ...
    public ClientRepo() {
        ...
        ClientDetails clientDetails1 = new ClientDetails("moniqueketje@home.nl", "06116667", "Nachtegaalstraat", 57, "Rood", "2025VH", "Haarlem");
        ...
        ClientDetails clientDetails2 = new ClientDetails("henk_jansen@home.nl", "0611746", "Brouwersplein", 2, "ZW", "2013PE", "Haarlem");
        ...
        ClientDetails clientDetails3 = new ClientDetails("bram.joos@home.nl", "0611675", "Witterstraat", 124, "bis A", "9401SE", "Assen");
        ...
        ClientDetails clientDetails4 = new ClientDetails("hannes1985@home.nl", "0614666", "Gangboord", 90, "F 4", "4902CA", "Oosterhout");
        ...
        ClientDetails clientDetails5 = new ClientDetails("sven.v.woert@home.nl", "0618766", "Sint Hubertuslaan", 95, "a", "6129LC", "Urmond");
        ...
        ClientDetails clientDetails6 = new ClientDetails("marta-schilder@home.nl", "0612666", "Vincent van Goghstraat", 106, "K204", "1318KV", "Almere");
        ...
        ClientDetails clientDetailsEmployee1 = new ClientDetails("markiiii_degekste@home.nl", "061456", "Molenweg", 3, null, "1234AB", "Eindhoven");
        PersonDetails personDetailsEmployee1 = new PersonDetails(nameEmployee1, "1992-01-01");
        ...
        ClientDetails clientDetailsEmployee2 = new ClientDetails("egbert1990@home.nl", "0611896", "Padvinderslaan", 199, "a", "3708BS", "Zeist");
        ...
        ClientDetails clientDetailsEmployee3 = new ClientDetails("Anna_Verkuilen@home.nl", "0617466", "Julianastraat", 153, "b", "4651BX", "Steenbergen");
        ...
        ClientDetails clientDetailsEmployee4 = new ClientDetails("janneke.linden@home.nl", "0622667", "Prins Bernhardlaan", 138, null, "6721DN", "Bennekom");
...
//        company3.setAccountManager(employee3);
        this.clients.add(company3);

        Login loginCompany4 = new Login("company4", "B4rryF4rm(*&(SDD1234004");
        ClientDetails clientDetailsCompany4 = new ClientDetails("info@barryfarm.nl", "0611220004", "Spiekerlanden", 4, "Z", "9407JD", "Hengelo");
...
//        company4.setAccountManager(employee5);
        ...
        ClientDetails clientDetailsCompany10 = new ClientDetails("info@sarah.nl", "0611220010", "Steenlaan", 10, "Z", "3833XV", "Kockengen");
        ...
        ClientDetails clientDetailsCompany11 = new ClientDetails("info@gastheergert.nl", "0611220010", "Waterweg", 11, "Z", "4383AK", "Rotterdam");
        ...
        ClientDetails clientDetailsCompany12 = new ClientDetails("info@developerdave.nl", "0611220012", "Bomenlaan", 12, "Z", "4707PZ", "Urk");
        ...
        ClientDetails clientDetailsCompany13 = new ClientDetails("info@m-machinebouw.nl", "0611220013", "Busstraat", 13, "Z", "9951GB", "Zeeland");
        ...
        ClientDetails clientDetailsCompany14 = new ClientDetails("info@pake-pakjes.nl", "0611220014", "Burghoven", 14, "Z", "9258CJ", "Winsum");
        ...
        ClientDetails clientDetailsCompany15 = new ClientDetails("info@nobodyknows.nl", "0611220015", "Takkenberg", 15, "Z", "1025JS", "Jistrum");
        ...
        ClientDetails clientDetailsCompany16 = new ClientDetails("info@bakker-ralf.nl", "0611220016", "Industrieweg", 16, "Z", "5256GA", "Rosmalen");
        ...
        ClientDetails clientDetailsCompany17 = new ClientDetails("info@groothandel-grover.nl", "0611220017", "Industrieweg", 17, "Z", "5552DN", "Heusden");
